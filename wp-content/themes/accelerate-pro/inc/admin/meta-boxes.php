 ...
 */
 ...
 add_action( 'add_meta_boxes', 'accelerate_add_custom_box' );
/**
 * Add Meta Boxes.
 */ 
function accelerate_add_custom_box() {
	// Adding layout meta box for page
	add_meta_box( 'page-layout', __( 'Select Layout', 'accelerate' ), 'accelerate_page_layout', 'page', 'side', 'default' ); 
	// Adding layout meta box for
	add_meta_box( 'page-layout', __( 'Select Layout', 'accelerate' ), 'accelerate_page_layout', 'post', 'side', 'default' ); 
}
...
$page_layout = array(
							'default-layout' 	=> array(
														'id'			=> 'accelerate_page_layout',
														'value' 		=> 'default_layout',
														'label' 		=> __( 'Default Layout', 'accelerate' )
														),
							'right-sidebar' 	=> array(
														'id'			=> 'accelerate_page_layout',
														'value' 		=> 'right_sidebar',
														'label' 		=> __( 'Right Sidebar', 'accelerate' )
														),
							'left-sidebar' 	=> array(
														'id'			=> 'accelerate_page_layout',
														'value' 		=> 'left_sidebar',
														'label' 		=> __( 'Left Sidebar', 'accelerate' )
														),
							'no-sidebar-full-width' => array(
															'id'			=> 'accelerate_page_layout',
															'value' 		=> 'no_sidebar_full_width',
															'label' 		=> __( 'No Sidebar Full Width', 'accelerate' )
															),
							'no-sidebar-content-centered' => array(
															'id'			=> 'accelerate_page_layout',
															'value' 		=> 'no_sidebar_content_centered',
															'label' 		=> __( 'No Sidebar Content Centered', 'accelerate' )
															)
						);
 ...
 */
function accelerate_page_layout() {  
...
add_action('pre_post_update', 'accelerate_save_custom_meta'); 
/**
 * save the custom metabox data
 * @hooked to pre_post_update hook
 */
function accelerate_save_custom_meta( $post_id ) { 
	global $page_layout, $post; 
